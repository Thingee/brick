...
XMLNS_VOLUME_V1 = ('http://docs.openstack.org/api/openstack-local-storage/1.0/'
                   'content')
...
def validate_schema(xml, schema_name):
    ...
    base_path = 'brick/api/schemas/v1.1/'
    if schema_name in ('atom', 'atom-link'):
        base_path = 'brick/api/schemas/'
    schema_path = os.path.join(utils.brickdir(),
