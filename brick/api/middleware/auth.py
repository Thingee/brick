...
from brick import context
from brick.i18n import _
from brick.openstack.common import jsonutils
from brick.openstack.common import log as logging
from brick.openstack.common.middleware import request_id
...
class InjectContext(base_wsgi.Middleware):
    """Add a 'brick.context' to WSGI environ."""
    ...
    def __call__(self, req):
        req.environ['brick.context'] = self.context
        return self.application


class BrickKeystoneContext(base_wsgi.Middleware):
