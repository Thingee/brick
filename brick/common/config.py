...
core_opts = [
    cfg.StrOpt('api_paste_config',
               ...
               help='File name for the paste.deploy config for brick-api'),
    cfg.StrOpt('state_path',
               default='/var/lib/brick',
               deprecated_name='pybasedir',
               help="Top-level directory for maintaining brick's state"), ]
...
global_opts = [
    ...
    cfg.BoolOpt('enable_v1_api',
                default=True,
                help=_("Deploy v1 of the Brick API.")),
    ...
    cfg.StrOpt('rootwrap_config',
               default='/etc/brick/rootwrap.conf',
