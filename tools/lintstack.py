...
# 'hashlib'.
ignore_messages = ["An attribute affected in brick.tests",
...
# checked elsewhere. We also ignore brick.tests for now due to high false
# positive rate.
ignore_modules = ["brick/openstack/common/", "brick/tests/"]
